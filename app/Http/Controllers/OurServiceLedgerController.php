...
use App\Services\LedgerTransactionForServices;
use App\Services\LedgerTransactionsProvider;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Auth;
use Illuminate\Support\Facades\Log;

class OurServiceLedgerController extends Controller
{
    protected $user;
    ...
    public function index()
    {
        ...
        return view('dashboard.ledgerOurServices.index', compact('services'));
    }
    ...
    public function show($id)
    {
        try {
            ...
            return view('dashboard.ledgerOurServices.showFromLedger', ['error' => 'An error occurred while fetching the service.', 'ledgers' => $ledgers]);
        }
    }
