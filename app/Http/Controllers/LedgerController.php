...
class LedgerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.ledger.index', compact('clients', 'employees', 'expenses', 'services'));
    }
    ...
    //     return view('dashboard.ledger.showSingleEntity', compact('client', 'ledger', 'service', 'employees'));
    // }
    ...
    public function clientServiceIndex($client_service_id)
    {
        ...
        return view('dashboard.ledger.ledger_client_service', compact('ledger', 'incomes', 'expenses', 'totalIncome', 'totalExpense', 'finalBalance'));
    }
