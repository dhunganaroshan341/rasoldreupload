...
<head>
    ...
    <link rel="stylesheet"
        type="text/css"href="{{ asset('public/src/plugins/jvectormap/jquery-jvectormap-2.0.3.css') }}">
...
<body>
    ...
    <div class="footer">
        <div class="footer-wrap pd-20 card-box">
            Billing Management System | All right reserved by <a href="" target="_blank">Roshan Dhungana</a>
        </div>
